                    ...
                    Row(
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Image.network('https://t4.ftcdn.net/jpg/04/68/74/75/360_F_468747500_VUYA3wtl0DV127YNq7jToCKwq9ABOTjC.jpg', width: 70,)
                        ),
                        SizedBox(width: 15,),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            SizedBox(height: 5,),
                            Text("Cleaner Contact: 9658439558 ", style: TextStyle(color: Colors.black.withOpacity(0.7), fontSize: 18),),
                          ],
                        )
                      ],
                    ),
